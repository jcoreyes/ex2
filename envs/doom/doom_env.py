...
try:
    ...
    from doom_py.vizdoom import ViZDoomUnexpectedExitException, ViZDoomErrorException, doom_fixed_to_double
...
DOOM_SETTINGS = [
    ...
    ['my_way_home2.cfg', 'my_way_home2.wad', '', 5, [13, 14, 15], -0.22, 0.5],                     # 5 - MyWayHome2
    ['health_gathering_hard.cfg', 'health_gathering_hard.wad', 'map01', 5, [13, 14, 15], 0, 1000],  # 4 - HealthGathering
    ['health_gathering_hard.cfg', 'health_gathering_supreme.wad', 'map01', 5, [13, 14, 15], 0, 1000],  # 4 - HealthGathering
]
...
class DoomEnv(gym.Env):
    ...
    def _step(self, action):
        ...
        try:
            ...
            info['x_pos'] = doom_fixed_to_double(self.game.get_game_variable(GameVariable.USER1))
            info['y_pos'] = doom_fixed_to_double(self.game.get_game_variable(GameVariable.USER2))
