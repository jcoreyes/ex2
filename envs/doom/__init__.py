...
from .doom_health_gathering import DoomHealthGatheringEnv, DoomHealthGatheringHardEnv, DoomHealthGatheringSupremeEnv
from .doom_my_way_home import DoomMyWayHomeEnv, DoomMyWayHomeCustomEnv
...
# Env registration
# ==========================
PACKAGE_NAME = 'ex2.envs.doom'

register(
    id='{}/meta-Doom-v0'.format(USERNAME),
    entry_point='{}:MetaDoomEnv'.format(PACKAGE_NAME),
...
register(
    ...
    entry_point='{}:DoomBasicEnv'.format(PACKAGE_NAME),
...
register(
    ...
    entry_point='{}:DoomCorridorEnv'.format(PACKAGE_NAME),
    timestep_limit=10000,
...
register(
    ...
    entry_point='{}:DoomDefendCenterEnv'.format(PACKAGE_NAME),
    timestep_limit=10000,
    reward_threshold=10.0,
)
...
register(
    ...
    entry_point='{}:DoomDefendLineEnv'.format(PACKAGE_NAME),
    timestep_limit=10000,
...
register(
    ...
    entry_point='{}:DoomHealthGatheringEnv'.format(PACKAGE_NAME),
    timestep_limit=10000,
    reward_threshold=1000.0,
)

register(
    id='{}/DoomHealthGatheringHard-v0'.format(USERNAME),
    entry_point='{}:DoomHealthGatheringHardEnv'.format(PACKAGE_NAME),
    timestep_limit=10000,
    reward_threshold=1000.0,
)

register(
    id='{}/DoomHealthGatheringSupreme-v0'.format(USERNAME),
    entry_point='{}:DoomHealthGatheringSupremeEnv'.format(PACKAGE_NAME),
    timestep_limit=10000,
    reward_threshold=1000.0,
)
...
register(
    ...
    entry_point='{}:DoomMyWayHomeEnv'.format(PACKAGE_NAME),
    timestep_limit=10000,
    reward_threshold=0.5,
)

register(
    id='{}/DoomMyWayHomeCustom-v0'.format(USERNAME),
    entry_point='{}:DoomMyWayHomeCustomEnv'.format(PACKAGE_NAME),
    timestep_limit=10000,
    reward_threshold=0.5,
)
...
register(
    ...
    entry_point='{}:DoomPredictPositionEnv'.format(PACKAGE_NAME),
    timestep_limit=10000,
    reward_threshold=0.5,
)
...
register(
    ...
    entry_point='{}:DoomTakeCoverEnv'.format(PACKAGE_NAME),
    timestep_limit=10000,
...
register(
    ...
    entry_point='{}:DoomDeathmatchEnv'.format(PACKAGE_NAME),
    timestep_limit=10000,
